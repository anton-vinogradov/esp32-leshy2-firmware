...
def build() -> dict:
    ...
    native_inventory_closed = (
        ...
        and native_inventory.get("summary", {}).get("component_group_count") == 239
    ...
    exact_ledger_closed = (
        ...
        and exact_ledger.get("summary", {}).get("component_group_count") == 239
        and exact_ledger.get("summary", {}).get("board_component_group_count") == 234
        and exact_ledger.get("summary", {}).get("explicit_non_pcba_group_count") == 5
        and exact_ledger.get("summary", {}).get("logical_contact_count") == 1656
