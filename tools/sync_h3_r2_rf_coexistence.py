...
def build() -> dict:
    scope = inspect_current_power([(SOURCE, "H3-R2-rf-coexistence")])
...
def main() -> int:
    ...
    if not OUTPUT.is_file() or OUTPUT.read_text(encoding="utf-8") != expected:
        ...
        return 1
    print("ok: current H3-R2.5 RF/coexistence contract is synchronized (see imported qualification status)")
    return 0
