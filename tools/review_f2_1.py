...
CHECKS = (
    ...
    (
        ...
        "source layout OK: 8 portable files",
    ),
    (
...
def main() -> int:
    ...
    print(
        "F2.1 integrated review OK: 8 portable files, 24 host scenarios, "
        "5 targets, 3 SDK families; no target project/build/emulator claim"
    )
    return 0
