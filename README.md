...
and reviewed `H1-R2.37`; its current point is `H2-R2.0.2`,
...
`H2-R2.0.1` reviewed the live `FSUSB42MUX/C11355` route. Current `H2-R2.0.2`
closes the exact service-VBUS detector/latch before the Pack/Safety
powered-off-Ioff boundary. Native R2
