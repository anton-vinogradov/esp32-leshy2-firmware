...
- Under [`DEC-0005`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/decisions/DEC-0005-zero-loss-cost.md), total product cost is optimized only through implementations proven equivalent in capability, performance, safety, reliability, autonomy, serviceability, and testability. The GNSS hardware/text mismatch is tracked as [`FND-0004`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/findings/FND-0004-gnss-scope-conflict.md).
