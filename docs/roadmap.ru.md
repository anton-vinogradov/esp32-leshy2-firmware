...
> Железо находится на H1-R2.11; инкрементальное размещение Hub/Airband/резерва K331,
...
> контролируемые максимальный корпус/посадочное место K331, фабричный маршрут,
> полный мокап, BSP и layout R2 ещё открыты. Эти два
...
| Пересечение с железом | ▶️ H0-R2 проведено ревью, H1-R2.11 сейчас; официальные схема включения K331/функции 14 контактов/таблица 24 каналов, консервативный резерв K331 30×24×4 мм, контролируемый, но деградированный fallback AWM666V, отклонённые полнофункциональные SP166RX/MM238R, placement Hub/Airband, фильтр/резерв Airband, исправленная edge/service-геометрия MMCX, точные LDO/TBS-антенна, независимый резерв Taoglas и пиновая/силовая совместимость K331 проходят текущие проверки; сейчас H1 блокируют только контролируемые максимальный корпус/посадочное место K331 и маршрут установки, затем следуют полные виды R2, а физическое RF/production-доказательство остаётся у H3/H5/H6/H8 |
