...
| Пересечение с железом | ▶️ H0-R2, H1-R2.37, H2-R2.1.5 и H3-R2 проведены ревью; H4-R2.0.2/H4-R2.1 находят назначенный пробел 38 BSP-строк C5/Pack/Safety, а H4-R2.2 его исправляет. H3-R2.4 доказывает прямой i8080-8 ровно 20 МГц, однозначное владение USB и паритет 80/80 контактов M1. Все 51 physical-остаток и отдельное обязательство F5/F6 по i8080 остаются открытыми. |
