...
> H2-R2.1.1 после ревью live route FSUSB42MUX/C11355 как H2-R2.0.1, точного тракта service-VBUS detector/latch/release как H2-R2.0.2 и границы TCA9803DGKR/C2687966 Pack/Safety как H2-R2.0.3. Точной импортированной pin/config
