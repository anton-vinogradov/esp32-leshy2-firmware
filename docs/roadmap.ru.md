...
> держателя/энкодера и позиции органов управления/портов RF. Карта Cap и GPIO/API прошивки не менялись.
...
> и 4 306 физических pins в двух native-проектах KiCad: 4 070 подключены,
> 236 явно не подключены; используются 788 глобальных канонических / 822 локальных для плат nets. Оба проекта
...
Последняя сверка текста об аппаратном статусе: **7 сентября 2026 года**. Это собственный роадмап
