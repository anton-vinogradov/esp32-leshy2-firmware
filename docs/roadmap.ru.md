...
> Полный [глобальный итог H3-R2](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/h3-r2-acceptance.ru.md) проведён ревью без mismatch и открытого аналитического finding; 51 physical-only строка остаётся назначенной H5/H6/H8. Контракты H3 импортированы fail-closed. Сохранённая диагностика H4 нашла назначенный пробел 38 BSP-строк C5/Pack/Safety; исправление восстановило 173/173 controller-строк H2, все 12 target-сборок повторно квалифицированы. [Глобальный итог H4-R2](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/h4-r2-acceptance.ru.md) проведён ревью без противоречий. Текущая аппаратная точка — H5.0.3-R1. H2-R2.1.1 провёл ревью трёх native-проектов, 23 sheets, шести владельцев доменов, 240 точных MPN-групп и 1 195 позиций. Точной импортированной pin/config
...
| Пересечение с железом | ✅ H0-R2 — глобальный H4-R2 проведены ревью; BSP покрывает 173/173 controller-строк H2, все 12 target-сборок проходят, междоменных противоречий нет. Сейчас выполняется hardware H5.0.3-R1. H3-R2.4 доказывает прямой i8080-8 ровно 20 МГц, однозначное владение USB и паритет 80/80 контактов M1. Все 51 physical-остаток и отдельное обязательство F5/F6 по i8080 остаются открытыми у точных владельцев. |
