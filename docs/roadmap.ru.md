...
| Объединённый аппаратный gate | ✅ H4 проведён; на H5.0.3 [JLCPCB Standard PCBA выбран неэксклюзивным ориентиром](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/manufacturing-platform.ru.md), 176/209 строк и все 1019 установок распознаны, остаются 33 явных outlier; закупка заблокирована |
