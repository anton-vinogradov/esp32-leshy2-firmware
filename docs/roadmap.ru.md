...
> Физическое H1-R2.37 принято и прошло ревью; текущая аппаратная точка —
> H2-R2.1.3 после того, как H2-R2.1.1 зафиксировал три native-проекта, 23 sheets, шесть владельцев доменов и 213 точных MPN-групп, а H2-R2.1.2 — 208 board groups, пять явных non-PCBA groups и 1 555 логических контактов. Более ранние live route FSUSB42MUX/C11355, точный тракт service-VBUS detector/latch/release и граница TCA9803DGKR/C2687966 Pack/Safety также прошли ревью. Точной импортированной pin/config
...
> сгенерированы. Сейчас материализуются controlled definitions и joined native
> nets; schematic export/KiCad placement ещё не начинались, заказ не разрешён.
