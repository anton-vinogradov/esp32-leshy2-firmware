...
> Железо находится на H1-R2.12; полные текущие виды размещения Hub/Airband/резерва K331,
...
> и JLCPCB; оба ответа ожидаются. Полные текущие внешние, зеркальные внутренние,
> сервисные, антенные виды и разрезы сгенерированы; при этом восстановлен
> пропущенный независимый набор Hub USB/RESET/BOOT/DBG10. Контролируемые
> максимальный корпус/посадочное место K331 и фабричный маршрут ещё открыты, а
> сгенерированный мокап остаётся in progress вместе с BSP и layout R2. Эти два
...
| Пересечение с железом | ▶️ H0-R2 проведено ревью, H1-R2.12 сейчас; полные текущие физические виды сгенерированы, все четыре вычислителя получили независимые USB/RESET/BOOT/DBG10, а границы K331/Airband/MMCX/power проходят свои текущие проверки; H1 блокируют только контролируемые максимальный корпус/посадочное место K331 и маршрут установки, а физическое RF/production-доказательство остаётся у H3/H5/H6/H8 |
