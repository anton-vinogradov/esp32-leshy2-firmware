...
> [Глобальный итог H3-R2](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/h3-r2-acceptance.ru.md) и [глобальный итог H4-R2](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/h4-r2-acceptance.ru.md) проведены ревью без открытого аналитического противоречия; 51 physical-only строка остаётся назначенной downstream. Текущая аппаратная точка — H5.0.3-R1. H2-R2.1.1 провёл ревью двух native-проектов, 22 sheets, шести владельцев доменов, 238 точных MPN-групп и 1 193 позиций. Точной импортированной pin/config
