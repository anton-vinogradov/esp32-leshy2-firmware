...
> независимые захваты PCB без нагрузки на M1. H6.0.1 завершена; принятый [bootstrap трассировки H6.0.2](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/h6-r2-routing-policy.ru.md)
> замыкает все 346/346 соединений `GENERAL_CONTROL` с нулём нарушений DRC, а кварцы, safety-control и аналоговые/audio/sense-сети остаются текущей работой. Locality-first
...
> завершена, bootstrap `GENERAL_CONTROL` проходит; критичная ручная трассировка
