...
> Taoglas проходят текущие gates, но корпус/
...
| Пересечение с железом | ▶️ H0-R2 проведено ревью, H1-R2.5 сейчас; placement Hub/Airband/резерва K331, фильтр/резерв Airband, точные MMCX/LDO/TBS-антенна, независимый резерв Taoglas и пиновая/силовая совместимость K331 проходят текущие gates; корпус/фабричный маршрут K331, полное placement, H3 bounded pre-layout proof, H6 routed extraction, H8 VNA и production-схема R2 открыты |
