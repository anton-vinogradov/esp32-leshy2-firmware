...
> H2-R2.1.2 после того, как H2-R2.1.1 зафиксировал три native-проекта, 23 sheets, шесть владельцев доменов и 213 точных MPN-групп без создания symbols или nets. Более ранние live route FSUSB42MUX/C11355, точный тракт service-VBUS detector/latch/release и граница TCA9803DGKR/C2687966 Pack/Safety также прошли ревью. Точной импортированной pin/config
...
> сгенерированы. Сейчас сверяются точные symbols/contacts/values/footprints;
> native R2 schematic nets/KiCad ещё не начинались, заказ не разрешён.
