...
| Объединённый аппаратный gate | ✅ H4 проведён по текущим dual-SA818S hashes H2/H3 и принятой F3; железо находится на H5.0.3-R1, пересобираются неустранимая корзина и 210 маршрутов JLCPCB; закупка заблокирована |
