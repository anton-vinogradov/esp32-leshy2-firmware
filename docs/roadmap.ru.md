...
| Объединённый аппаратный gate | ✅ H4 проведён; на H5.0.3 [JLCPCB Standard PCBA выбран неэксклюзивным ориентиром](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/manufacturing-platform.ru.md), сопоставлены 10/209 critical/BOM-строк и полный аудит — текущая работа; минимальный upload ожидает пользовательского входа, закупка заблокирована |
