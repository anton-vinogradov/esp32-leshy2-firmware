...
| Пересечение с железом | ✅ H0-R2 — актуальный итог маршрутов H5-R2 проведены ревью. ▶️ Разводка H6.0.3-R1 проходит повторную квалификацию; её точный прогресс ведётся в аппаратном срезе по ссылке выше. H3-R2.4 доказывает прямой i8080-8 ровно 20 МГц, однозначное владение USB и паритет 80/80 контактов M1. Все 51 physical-остаток и отдельное обязательство F5/F6 по i8080 остаются открытыми у точных владельцев. |
