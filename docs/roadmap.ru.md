...
> сохраняют границы своих проверенных исходных версий. Снимок H5 охватывает 249
> закупаемых групп / 1 216 изделий без неназначенных маршрутов и с явной проверкой
> `WBC16-1TLC` перед заказом; он не заменяет новую проверку непосредственно перед закупкой.
...
> 22 sheets, шести владельцев доменов, 251 точной component-group и 1 218 позиций.
> Точной импортированной pin/config
...
> Текущие находки питания: R67 1,65 кОм вместо принятой H3 величины 1,18 кОм,
> модель TPS564252 вместо установленного TPS566231P, недостаточный worst-case
> запас срабатывания main PGTH и ограничение сопротивления AON eFuse по неверному
> условию RILIM. Детали питания не менялись; синхронизация H3 не доказывает запуск под питанием.
...
Последняя сверка текста об аппаратном статусе: **8 сентября 2026 года**. Это собственный роадмап
