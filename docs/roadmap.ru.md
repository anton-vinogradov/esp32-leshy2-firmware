...
> 4 064 подключённых endpoints, 238 явных no-connects и 788 глобальных канонических / 822 локальных для плат nets; оба проекта
...
> такая аппаратная проверка остаётся обязательной до производственного выпуска. H2-R2.1.4 свёл шесть доменов,
