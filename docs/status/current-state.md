...
- `FND-0020`: nRF24 RPD is a binary threshold, not RSSI/dBm/bearing; the radio can source a test carrier but cannot measure VSWR.
...
The 3×nRF24 prerequisite audit is **Reviewed** under `REV-0002T`; draft [`REQ-N24-0001`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/requirements/REQ-N24-0001-three-nrf24-raw-2g4.md) is **In review**. Current hardware remains S3-routed and no active C5 driver/security state machine/HIL exists. RPD is specified only as calibrated binary hit-rate statistics, and the constant-carrier mode is not a VSWR meter. Passive ESB/MouseJack discovery, sensitive KeySniffer capture, active injection, address brute-force, and interference tests have separate gates; interference/carrier sweeps are conducted or RF-shielded `BOTH` only, and GPL references are not treated as MIT-reusable code. **⚠️ Proposal [`IMP-0016`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/improvements/IMP-0016-calibrated-three-antenna-2g4-hunt.md)** recommends a no-new-BOM comparative RPD hit-rate baseline; real-power RF hardware is the alternative. **⚠️ Proposal [`IMP-0017`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/improvements/IMP-0017-native-ble-plus-nrf24-compatibility.md)** is deferred to BLE-owner review.
