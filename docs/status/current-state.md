...
Local [`docs/architecture/README.md`](../architecture/README.md) keeps the prohibition on a premature runtime winner. The next hardware inputs are quantitative memory/traffic/power/RF/cost budgets; the firmware target README remains unchanged until atomic acceptance of the complete architecture.
