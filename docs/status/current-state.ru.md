...
- `FND-0025`: raw/full-stack 802.15.4 технически шире legacy passive-only, но ordinary Thread/Zigbee scope и shared-radio coexistence ждут `IMP-0018`.
...
C5 Wi-Fi/IEEE 802.15.4 prerequisite audit получил статус **«Проведено ревью пререквизитов»** в [`REV-0002V`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/reviews/REV-0002V-c5-wifi-802154-prerequisites.md). Public promiscuous RX отделён от ограниченного raw TX и любого private patched binary; simultaneous dual-band, arbitrary management injection, DFS SoftAP и full/lossless monitor не обещаны. Country/DFS/PMF/privacy и one-radio coexistence стали обязательными gates. Raw 802.15.4, OpenThread и Zigbee roles доступны без нового RF BOM, но Zigbee core proprietary prebuilt. [`REQ-W5-0001`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/requirements/REQ-W5-0001-c5-wifi-ieee802154.md) остаётся **«На ревью»**. **⚠️ Предложение [`IMP-0018`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/improvements/IMP-0018-open-first-thread-and-zigbee-scope.md)** просит выбрать open-first Thread + conditional Zigbee, open-only Thread/raw или passive-only. Target README не изменён до ответа владельца.
