...
Прежние stage-3 layouts и nRF-owner proposals теперь справочный архив. Они не задают firmware ownership, transport или HAL. Новая каноническая цепочка начинается с hardware [`CAP-0001`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/architecture/CAP-0001-zero-based-capability-input.md), покрывающего весь wishlist без pin/bus allocation и получившего статус **«Проведено ревью»** в `REV-0003J`. Hardware [`CON-0001`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/architecture/CON-0001-hardware-neutral-concurrency-model.md) зафиксировал обязательную параллельность, time-sharing и failure behavior без назначения владельцев (`REV-0003K`), а [`RES-0001`](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/review/architecture/RES-0001-hardware-neutral-resource-demand.md) вывел логические compute/interface/timing/power obligations без MCU/GPIO placement (`REV-0003L`).
