...
| Hardware joined gate | ✅ H4 reviewed; at H5.0.3 [JLCPCB Standard PCBA is the non-exclusive reference](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/manufacturing-platform.md), 176/209 lines and all 1019 placements are parsed, all 209 lines have exact `J0`–`J3`, `J4-F` or `J4-P` routes; exact SA518 pricing and factory final-assembly gates remain open, generic `C9900300438` is rejected as NiceRF evidence, and JLCAPI Parts permission is reviewing; purchasing is blocked |
