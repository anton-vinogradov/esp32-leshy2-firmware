...
> H1-R2.3; its incremental Hub/Airband/FPV placement, Airband filter feasibility
> audit/tuning cell and exact MMCX/LDO closure pass their current checks,
> but there is no complete R2 rail, BSP or layout.
...
| Hardware intersection | ▶️ Hardware H0-R2 is reviewed and H1-R2.3 is current; Hub/Airband/FPV placement, Airband filter feasibility/tuning reserve and exact MMCX/LDO closure pass their current gates, while complete R2 placement, power and production schematic remain open |
