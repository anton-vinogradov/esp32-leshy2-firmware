...
> accepted and reviewed; hardware H2 is reviewed at H2-R2.1.5, H3-R2.0.1 froze the stable verification inputs, H3-R2.0.2 reviewed provenance for all 242 groups and 1,187 fitted positions, H3-R2.0.3 froze nine methods and twelve pass/fail rules, H3-R2.1.1 reviewed 2,266 legal power states, H3-R2.1.2 reviewed explicit binding for 612 fitted powered instances (596 direct and 16 indirect) and six external loads, H3-R2.1.3 reviewed 224 passing profiles across all four rails, and H3-R2.1.4 source/charge verification is current. H2-R2.1.1 reviewed three native projects, 23 sheets, six domain owners, 242 exact MPN groups and 1,197 product positions, and H2-R2.1.2 reviewed 237 board groups, five explicit non-PCBA groups and 1,662 logical contacts. The earlier live FSUSB42MUX/C11355 route, exact service-VBUS detector/latch/release path and TCA9803DGKR/C2687966 Pack/Safety boundary are also reviewed. Its exact imported pin/config authority remains the reviewed
...
> five rear-RP GPIOs and eleven M1 contacts remain reserves. Current exterior,
