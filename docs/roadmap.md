...
> H1-R2.17; its locality-first two-board placement, Airband filter feasibility
...
| Hardware intersection | ▶️ Hardware H0-R2 is reviewed and H1-R2.17 is current; ten SMA ports are split 5+5, the vertical rear-face FPV MMCX has no interboard tail, TVP5150 stays front-local and M1 carries one CVBS signal; K331 RSSI is officially NC and decoder lock is the supported evidence; only one AKK-controlled K331 production package blocks H1, while Consigned Parts/DFM/function-test review follows in H5/H6/H7 and H3/H5/H6/H8 retain physical RF proof |
