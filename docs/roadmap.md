...
| Hardware joined gate | ✅ H4 reviewed; at H5.0.3 [JLCPCB Standard PCBA is the non-exclusive reference](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/manufacturing-platform.md), 10/209 critical/BOM lines are mapped and the full audit is current; minimum upload awaits user sign-in and purchasing is blocked |
