...
> H1-R2.4; its incremental Hub/Airband/FPV placement, Airband filter feasibility
> audit/tuning cell, exact MMCX/LDO closure and 3.75-A continuous / 4.25-A step
> 3V3_MAIN architecture pass their current checks, but there is no complete R2
> mockup, BSP or layout.
...
| Hardware intersection | ▶️ Hardware H0-R2 is reviewed and H1-R2.4 is current; Hub/Airband/FPV placement, Airband filter feasibility/tuning reserve, exact MMCX/LDO and the 3V3_MAIN admission architecture pass their current gates, while complete R2 placement, H3 dynamic/thermal proof and production schematic remain open |
