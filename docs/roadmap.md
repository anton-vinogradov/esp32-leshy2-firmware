...
> accepted and reviewed; hardware is now at H2-R2.1.1 after reviewing the live FSUSB42MUX/C11355 route as H2-R2.0.1, the exact service-VBUS detector/latch/release path as H2-R2.0.2 and the TCA9803DGKR/C2687966 Pack/Safety boundary as H2-R2.0.3. Its exact imported pin/config authority remains the reviewed
