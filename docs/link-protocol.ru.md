...
Глубокая дока к решению [«Архитектура системы»](../README.ru.md#5-архитектура-системы). **ESP32-S3** — мозг и мастер шины; **ESP32-C5** — тонкий 5 ГГц-агент, которого может тактировать только S3. Этот документ — узкий версионированный контракт между ними: как байт на проводе становится командой или событием и как линк остаётся корректным при потере кадров.
