...
В H1-R2.38 шлейф экрана физически направлен к антенному торцу и прямо в ZIF передней платы, поэтому S3-драйвер
...
24 возврата и 11 настоящих NC-резервов. M1 выполняет только электрическую функцию и совмещение;
