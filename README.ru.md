...
fail-closed; текущая аппаратная точка — `H3-R2.3`. H3-R2.1.2
...
4 067 подключённых endpoints, 256 явных no-connects и 826 канонических nets;
все три проекта проходят KiCad ERC с нулём ошибок и предупреждений. На
`H2-R2.1.4` сведены шесть доменов, 173 строки контроллеров, 52 межпроектные и
238 межлистовых nets; firmware sync gate результата `H2-R2.1.5` открыт. Теперь
