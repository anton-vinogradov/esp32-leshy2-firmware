...
- Два слота для заменяемых квалифицированных 18650 показываются отдельно и как
  контролируемый battery set. Опасное сочетание, извлечение ячейки, ошибка
  контакта или неполная battery identity блокируют затронутую работу/зарядку и
