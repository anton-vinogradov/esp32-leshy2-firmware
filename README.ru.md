...
железо находится на `H1-R2.36` и готово к визуальному принятию компоновки, а точной импортированной pin/config authority
...
принятая смена корпуса AD8314 не меняет видимые прошивке сети или поведение.
