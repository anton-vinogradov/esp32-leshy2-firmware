...
железо находится на `H1-R2.33` и готово к визуальному принятию компоновки, а точной импортированной pin/config authority
...
вертикального FPV-разъёма. S3 сохраняет прямой i8080-8 24 МГц к точному `ER-TFT035IPS-6` + `ER-TPC035-6`, camera RX,
