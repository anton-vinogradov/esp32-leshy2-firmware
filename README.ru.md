...
железо находится на `H1-R2.37` и готово к визуальному принятию компоновки, а точной импортированной pin/config authority
...
принятые смена корпуса AD8314 и точная упаковочная версия Hirose U.FL снижают стоимость железа, не меняя видимые прошивке сети или поведение.
...
Текущий мокап R2 проходит structural body/courtyard audit, но сохраняет три
явных H1-блокера: точные значения/MPN и courtyards вспомогательных пассивов
U219, контролируемую или измеренную геометрию NFC pickup и swept volume
установленной RP-SMA-антенны U219. После
