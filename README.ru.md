...
находится на `H1-R2.6`: корпуса Hub/Airband/резерв K331, точный MMCX и LDO получили
инкрементальное
размещение с проверкой коллизий, фильтр Airband — nominal/stress-аудит и
ячейку настройки 24×11 мм, а порты и антенны — совпадающие коды. K331
...
и JLCPCB; оба ответа ожидаются, поэтому контролируемый корпус и фабричный
маршрут K331 ещё открыты. Это единственные два текущих блокера H1; доказательство
собранного RF/video-тракта и запасная Taoglas остаются обязательными у
последующих H3/H5/H6/H8. Точный MMCX теперь зарегистрирован как 3,6 мм корпуса
