...
автоматического перезапуска. Точные firmware-контракты
[последовательностей](config/h3_r2_transition_contract.json) и
[handover](config/h3_r2_handover_contract.json) импортированы fail-closed;
текущая аппаратная точка — `H3-R2.2.3`. H3-R2.1.2
