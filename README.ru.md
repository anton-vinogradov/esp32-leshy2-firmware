...
находится на `H1-R2.12`: корпуса Hub/Airband/резерв K331, точный MMCX и LDO получили
...
Текущий мокап R2 остаётся in progress до фиксации корпуса и маршрута установки
K331; BSP, KiCad layout и разрешение заказа остаются открыты.
