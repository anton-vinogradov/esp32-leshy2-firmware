...
железо завершило `H1-R2.38`, принято и прошло ревью; H2 прошло ревью как
...
проведён ревью без противоречий. [Глобальный итог H5-R1](https://github.com/anton-vinogradov/esp32-leshy2/blob/main/docs/h5-r1-acceptance.ru.md)
проводит ревью 210/210 контролируемых component/factory routes без замен. Текущая аппаратная точка — `H6.0.1-R1`. H3-R2.1.2
провёл ревью явной привязки 611 устанавливаемых питаемых экземпляров — 595
...
native-проектов, 22 sheets, шести владельцев доменов, 238 точных MPN-групп
и 1 193 позиций. `H2-R2.1.2` закрыл exact identities для 232 board groups,
шести non-PCBA groups и 1 578 логических контактов. `H2-R2.1.3`
материализовал 1 183 устанавливаемых позиций и 4 243 физических pins
в двух native-проектах KiCad. Все 4 239 ledger-endpoints сведены в
4 002 подключённых endpoints, 237 явных no-connects и 816 канонических nets;
оба проекта проходят KiCad ERC с нулём ошибок и предупреждений. На
`H2-R2.1.4` сведены шесть доменов, 173 строки контроллеров, 35 межпроектных и
230 межлистовых nets; firmware sync gate результата `H2-R2.1.5` открыт. Теперь
