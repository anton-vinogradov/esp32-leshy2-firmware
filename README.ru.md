...
`H2-R2.1.2`, а точной импортированной pin/config authority
...
создания symbols или nets. В `H2-R2.1.2` сверяются точные symbols, contacts,
values и footprints; schematic export/KiCad ещё не начинался, а
