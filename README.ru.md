...
`H2-R2.1.5`, текущая аппаратная точка — `H3-R2.0.3`; точная фиксация входов
`H3-R2.0.1` и реестр происхождения параметров/моделей `H3-R2.0.2` проведены
ревью, а точной импортированной pin/config authority
