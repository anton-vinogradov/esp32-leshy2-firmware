...
`H2-R2.1.5`, текущая аппаратная точка — `H3-R2.1`; точная фиксация входов
`H3-R2.0.1`, реестр происхождения параметров/моделей `H3-R2.0.2` и контракт
методов `H3-R2.0.3` проведены ревью, а точной импортированной pin/config authority
