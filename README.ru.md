...
`H2-R2.1.5`, текущая аппаратная точка — `H3-R2.1.5`; H3-R2.1.2 провёл
...
2 266 состояний; максимальный ток pack — 3,516 А, заряд всегда уступает системной нагрузке. Точная фиксация входов
