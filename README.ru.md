...
- Контролируемая батарея 2S показывает две заменяемые квалифицированные 18650
  ...
  сравнивает обе ячейки; независимый non-retriggerable аппаратный таймер не
  позволяет зависшей firmware растянуть импульс. Factory acceptance также
...
- Поддерживаются только exact MPN квалифицированных защищённых button-top
  18650 в поляризованном `Keystone 1048P`; raw flat-top не поддерживаются.
