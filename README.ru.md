...
`H2-R2.1.5`, текущая аппаратная точка — `H3-R2.1.3`; H3-R2.1.2 провёл
ревью явной привязки 612 устанавливаемых питаемых экземпляров — 596 прямых и 16 косвенных — и шести внешних нагрузок; точная фиксация входов
