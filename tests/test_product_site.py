...
class ProductSiteTests(unittest.TestCase):
    ...
    def test_landing_pages_describe_capabilities_not_project_history(self):
        ...
        landing_pages = {
            "README.md": (
                "Firmware roadmap and current position", "Firmware is at F2-R2.2",
                "H1-R2.26", "flex toward the antenna edge", "touch coordinates by 180 degrees",
            ),
            "README.ru.md": (
                "Роадмап прошивки и текущая позиция", "Прошивка находится на F2-R2.2",
    ...
    def test_current_firmware_substep_is_visible_and_synchronized(self):
        ...
        self.assertEqual({"F2-R2.2"}, set(markers.values()))
