...
class ProductSiteTests(unittest.TestCase):
    ...
    def test_public_hardware_marker_separates_physical_and_machine_authority(self):
        ...
        self.assertEqual("H3-R2.2.3", boundary["current_hardware_substep"])
    ...
    def test_hardware_integration_contract_matches_firmware(self):
        ...
        self.assertEqual(826, reconciliation["native_kicad"]["summary"]["canonical_net_count"])
        self.assertEqual(173, reconciliation["h2_hwfw_reconciliation"]["summary"]["controller_pin_rows"])
        self.assertEqual(51, reconciliation["h2_hwfw_reconciliation"]["summary"]["cross_project_net_count"])
        self.assertEqual(236, reconciliation["h2_hwfw_reconciliation"]["summary"]["cross_sheet_net_count"])
