...
class ProductSiteTests(unittest.TestCase):
    ...
    def test_landing_pages_describe_capabilities_not_project_history(self):
        ...
        landing_pages = {
            "README.md": ("Firmware roadmap and current position", "Firmware is at F0-R2.0", "H1-R2.10"),
            "README.ru.md": ("Роадмап прошивки и текущая позиция", "Прошивка находится на F0-R2.0", "H1-R2.10"),
        }
