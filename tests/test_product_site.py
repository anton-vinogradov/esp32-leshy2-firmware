...
class ProductSiteTests(unittest.TestCase):
    ...
    def test_public_hardware_marker_separates_physical_and_machine_authority(self):
        ...
        self.assertEqual("H6.0.1-R1", boundary["current_hardware_substep"])
        ...
        self.assertTrue(state["current_claims"]["h4_r2_0_2_contract_reconciliation_imported"])
        self.assertTrue(state["current_claims"]["h4_r2_2_bsp_correction_reviewed"])
        self.assertTrue(state["current_claims"]["h4_r2_3_joined_prelayout_gate_reviewed"])
        self.assertTrue(state["current_claims"]["h5_r2_1_current_routes_reviewed"])
        ...
        self.assertTrue(state["current_claims"]["h3_r2_4_digital_result_reviewed"])
        self.assertTrue(state["current_claims"]["h3_r2_6_thermal_fault_contract_imported"])
