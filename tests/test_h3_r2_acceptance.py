...
class H3R2AcceptanceContractTests(unittest.TestCase):
    ...
    def test_reviewed_boundary_and_residuals_are_exact(self):
        ...
        self.assertEqual("H6.0.3-R1", self.contract["current_hardware_substep"])
        self.assertGreater(boundary["open_analytical_findings"], 0)
        self.assertFalse(self.contract["claims"]["h3_r2_analytical_scope_imported"])
